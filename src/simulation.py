...
if __name__ == '__main__':
        ...
        for k in range(10):
            ...
            for s in range(nodes):
                for d in range(nodes):
                    ...
                    res = Algorithms.heuristic_algorithm(traffic, G, adj_matrix_with_lightpath, tafs, weight=MRU)
    ...
    # scio.savemat(file, {'data_min': DKR_ERR[0], 'data_mean': DKR_ERR[1], 'data_max': DKR_ERR[2],
    #                     'key_min': DKR_ERR[3], 'key_mean': DKR_ERR[4], 'key_max': DKR_ERR[5]})
